...
module.exports = class RejuvenationBotService extends Schmervice.Service {
    ...
    async onMemberJoin(member) {
        ...
        console.log('welcomeCategory', welcomeCategory);
    ...
    async handleWelcomeChannels(message) {
        ...
        console.log('nextQuestionStep', nextQuestionStep);
        ...
        switch (nextQuestionStep) {
            ...
            default:
                // If no bot messages found, start from Q1
                await message.channel.send(this.getWelcomeApplicationStep('Q1'));
                break;
        }
    }
