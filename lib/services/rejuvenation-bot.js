...
module.exports = class RejuvenationBotService extends Schmervice.Service {
    ...
    async onMemberJoin(member) {
        ...
        await newWelcomeChannel.send(discordService.buildMessage({
    ...
    getWelcomeApplicationStep(stepName) {
        ...
        switch (stepName) {
            ...
            case 'Welcome2':
                return `⊹˚₊‧─────────────────────────────────────────────────────────‧₊˚⊹\nAs stated in our bio, we aim to maintain a positive atmosphere in our server. To help maintain that, we ask that you answer the following 3 questions.\n\nIf you are new to the faith (WELCOME!), it's ok if you don\'t know how to answer these questions, just give your best answer for now and we\'ll be happy to talk about things after.`;
            case 'Q1':
