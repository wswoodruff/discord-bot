...
module.exports = class RejuvenationBotService extends Schmervice.Service {
    ...
    getWelcomeApplicationStep(stepName) {
        ...
        switch (stepName) {
            ...
            case 'Welcome2':
                return `⊹˚₊‧─────────────────────────────────────────────────────────‧₊˚⊹\nAs stated in our bio, we aim to maintain a positive atmosphere in our server. To help maintain that, we ask that you answer the following 3 questions.\n\nWe understand that some people may be new to the faith (WELCOME!!), so if you don\'t know how to answer these questions and are needing guidance, just give your best answer for now and we\'ll be happy to talk about things after.`;
            case 'Q1':
