...
module.exports = class RejuvenationBotService extends Schmervice.Service {
    ...
    async onMessage(message) {
        ...
        else if (message.content.includes('!disappointed') || message.content.includes('!handsonhips')) {
            response = 'https://media1.tenor.com/m/6YpqK8I0NBoAAAAd/disappointed-hands-on-hips.gif';
        }
    ...
    async onMemberJoin(member) {
        ...
        const botLogsChannel = member.guild.channels.cache.find((channel) => channel.name === BOT_LOGS_CHANNEL_NAME);
