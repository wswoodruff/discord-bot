...
module.exports = class DiscordService extends Schmervice.Service {
    ...
    constructor(server, options) {
        ...
        this.client = new Client({
            intents: [
                ...
                GatewayIntentBits.DirectMessages,        // Required to receive and respond to DMs
    ...
    onMessageEdit(oldMessage, newMessage) {
        ...
        console.log('MESSAGE EDITED OLD MSG!', oldMessage);
        console.log('MESSAGE EDITED OLD MSG!', newMessage);
